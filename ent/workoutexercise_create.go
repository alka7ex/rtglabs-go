...
func (wec *WorkoutExerciseCreate) SetOrder(i int) *WorkoutExerciseCreate {
	wec.mutation.SetOrder(i)
	return wec
}

// SetSets sets the "sets" field.
func (wec *WorkoutExerciseCreate) SetSets(i int) *WorkoutExerciseCreate {
	wec.mutation.SetSets(i)
	return wec
}

// SetReps sets the "reps" field.
func (wec *WorkoutExerciseCreate) SetReps(i int) *WorkoutExerciseCreate {
	wec.mutation.SetReps(i)
	return wec
}
...
func (wec *WorkoutExerciseCreate) check() error {
	...
	if _, ok := wec.mutation.Order(); !ok {
		return &ValidationError{Name: "order", err: errors.New(`ent: missing required field "WorkoutExercise.order"`)}
	}
	if _, ok := wec.mutation.Sets(); !ok {
		return &ValidationError{Name: "sets", err: errors.New(`ent: missing required field "WorkoutExercise.sets"`)}
	}
	if _, ok := wec.mutation.Reps(); !ok {
		return &ValidationError{Name: "reps", err: errors.New(`ent: missing required field "WorkoutExercise.reps"`)}
	}
	if _, ok := wec.mutation.Weight(); !ok {
		return &ValidationError{Name: "weight", err: errors.New(`ent: missing required field "WorkoutExercise.weight"`)}
	}
	if _, ok := wec.mutation.CreatedAt(); !ok {
