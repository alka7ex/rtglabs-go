...
func (su *SessionUpdate) SetToken(u uuid.UUID) *SessionUpdate {
	su.mutation.SetToken(u)
	return su
}

// SetNillableToken sets the "token" field if the given value is not nil.
func (su *SessionUpdate) SetNillableToken(u *uuid.UUID) *SessionUpdate {
	if u != nil {
		su.SetToken(*u)
	}
	return su
...
func (su *SessionUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := su.mutation.Token(); ok {
		_spec.SetField(session.FieldToken, field.TypeUUID, value)
	}
...
// SetToken sets the "token" field.
func (suo *SessionUpdateOne) SetToken(u uuid.UUID) *SessionUpdateOne {
	suo.mutation.SetToken(u)
	return suo
}

// SetNillableToken sets the "token" field if the given value is not nil.
func (suo *SessionUpdateOne) SetNillableToken(u *uuid.UUID) *SessionUpdateOne {
	if u != nil {
		suo.SetToken(*u)
	}
	return suo
