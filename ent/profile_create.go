...
func (pc *ProfileCreate) SetHeight(f float64) *ProfileCreate {
	pc.mutation.SetHeight(f)
	return pc
}

// SetGender sets the "gender" field.
func (pc *ProfileCreate) SetGender(i int) *ProfileCreate {
	pc.mutation.SetGender(i)
	return pc
}

// SetWeight sets the "weight" field.
func (pc *ProfileCreate) SetWeight(f float64) *ProfileCreate {
...
func (pc *ProfileCreate) check() error {
	...
	if _, ok := pc.mutation.Height(); !ok {
		return &ValidationError{Name: "height", err: errors.New(`ent: missing required field "Profile.height"`)}
	}
