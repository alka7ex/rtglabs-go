...
// HasBodyweights applies the HasEdge predicate on the "bodyweights" edge.
func HasBodyweights() predicate.User {
...
// HasBodyweightsWith applies the HasEdge predicate on the "bodyweights" edge with a given conditions (other predicates).
func HasBodyweightsWith(preds ...predicate.Bodyweight) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newBodyweightsStep()
