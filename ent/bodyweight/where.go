...
func UserIDGT(v uuid.UUID) predicate.Bodyweight {
	return predicate.Bodyweight(sql.FieldGT(FieldUserID, v))
}

// UserIDGTE applies the GTE predicate on the "user_id" field.
func UserIDGTE(v uuid.UUID) predicate.Bodyweight {
	return predicate.Bodyweight(sql.FieldGTE(FieldUserID, v))
}

// UserIDLT applies the LT predicate on the "user_id" field.
func UserIDLT(v uuid.UUID) predicate.Bodyweight {
	return predicate.Bodyweight(sql.FieldLT(FieldUserID, v))
}

// UserIDLTE applies the LTE predicate on the "user_id" field.
func UserIDLTE(v uuid.UUID) predicate.Bodyweight {
	return predicate.Bodyweight(sql.FieldLTE(FieldUserID, v))
}
