...
func (wlq *WorkoutLogQuery) QueryUser() *UserQuery {
...
func (wlq *WorkoutLogQuery) QueryWorkout() *WorkoutQuery {
...
func (wlq *WorkoutLogQuery) QueryExerciseSets() *ExerciseSetQuery {
	query := (&ExerciseSetClient{config: wlq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := wlq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (wlq *WorkoutLogQuery) QueryExerciseInstances() *ExerciseInstanceQuery {
	query := (&ExerciseInstanceClient{config: wlq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := wlq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (wlq *WorkoutLogQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (wlq *WorkoutLogQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (wlq *WorkoutLogQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (wlq *WorkoutLogQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (wlq *WorkoutLogQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (wlq *WorkoutLogQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := wlq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (wlq *WorkoutLogQuery) Clone() *WorkoutLogQuery {
	...
	return &WorkoutLogQuery{
		...
		withUser:              wlq.withUser.Clone(),
		withWorkout:           wlq.withWorkout.Clone(),
		withExerciseSets:      wlq.withExerciseSets.Clone(),
		withExerciseInstances: wlq.withExerciseInstances.Clone(),
...
func (wlq *WorkoutLogQuery) WithUser(opts ...func(*UserQuery)) *WorkoutLogQuery {
	query := (&UserClient{config: wlq.config}).Query()
...
func (wlq *WorkoutLogQuery) WithWorkout(opts ...func(*WorkoutQuery)) *WorkoutLogQuery {
	query := (&WorkoutClient{config: wlq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	wlq.withWorkout = query
	return wlq
}
...
func (wlq *WorkoutLogQuery) WithExerciseSets(opts ...func(*ExerciseSetQuery)) *WorkoutLogQuery {
	query := (&ExerciseSetClient{config: wlq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	wlq.withExerciseSets = query
	return wlq
}
...
func (wlq *WorkoutLogQuery) WithExerciseInstances(opts ...func(*ExerciseInstanceQuery)) *WorkoutLogQuery {
	query := (&ExerciseInstanceClient{config: wlq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	wlq.withExerciseInstances = query
	return wlq
}
...
//		GroupBy(workoutlog.FieldCreatedAt).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.WorkoutLog.Query().
//		Select(workoutlog.FieldCreatedAt).
//		Scan(ctx, &v)
...
func (wlq *WorkoutLogQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*WorkoutLog, error) {
	var (
		...
		loadedTypes = [4]bool{
			wlq.withUser != nil,
			wlq.withWorkout != nil,
			wlq.withExerciseSets != nil,
			wlq.withExerciseInstances != nil,
		}
	)
	if wlq.withUser != nil || wlq.withWorkout != nil {
		withFKs = true
	}
	if withFKs {
	...
	if query := wlq.withUser; query != nil {
		if err := wlq.loadUser(ctx, query, nodes, nil,
			func(n *WorkoutLog, e *User) { n.Edges.User = e }); err != nil {
			return nil, err
		}
	}
	if query := wlq.withWorkout; query != nil {
		if err := wlq.loadWorkout(ctx, query, nodes, nil,
			func(n *WorkoutLog, e *Workout) { n.Edges.Workout = e }); err != nil {
			return nil, err
		}
	}
	if query := wlq.withExerciseSets; query != nil {
		if err := wlq.loadExerciseSets(ctx, query, nodes,
			func(n *WorkoutLog) { n.Edges.ExerciseSets = []*ExerciseSet{} },
			func(n *WorkoutLog, e *ExerciseSet) { n.Edges.ExerciseSets = append(n.Edges.ExerciseSets, e) }); err != nil {
			return nil, err
		}
	}
	if query := wlq.withExerciseInstances; query != nil {
		if err := wlq.loadExerciseInstances(ctx, query, nodes,
			func(n *WorkoutLog) { n.Edges.ExerciseInstances = []*ExerciseInstance{} },
			func(n *WorkoutLog, e *ExerciseInstance) {
...
func (wlq *WorkoutLogQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*WorkoutLog, init func(*WorkoutLog), assign func(*WorkoutLog, *User)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*WorkoutLog)
	for i := range nodes {
		if nodes[i].user_workout_logs == nil {
			continue
		}
		fk := *nodes[i].user_workout_logs
	...
	for _, n := range neighbors {
		...
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "user_workout_logs" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
...
func (wlq *WorkoutLogQuery) loadWorkout(ctx context.Context, query *WorkoutQuery, nodes []*WorkoutLog, init func(*WorkoutLog), assign func(*WorkoutLog, *Workout)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*WorkoutLog)
	for i := range nodes {
...
func (wlq *WorkoutLogQuery) loadExerciseSets(ctx context.Context, query *ExerciseSetQuery, nodes []*WorkoutLog, init func(*WorkoutLog), assign func(*WorkoutLog, *ExerciseSet)) error {
	...
	query.Where(predicate.ExerciseSet(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(workoutlog.ExerciseSetsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.workout_log_exercise_sets
		if fk == nil {
			return fmt.Errorf(`foreign-key "workout_log_exercise_sets" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "workout_log_exercise_sets" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (wlq *WorkoutLogQuery) loadExerciseInstances(ctx context.Context, query *ExerciseInstanceQuery, nodes []*WorkoutLog, init func(*WorkoutLog), assign func(*WorkoutLog, *ExerciseInstance)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*WorkoutLog)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.ExerciseInstance(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(workoutlog.ExerciseInstancesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.workout_log_exercise_instances
		if fk == nil {
			return fmt.Errorf(`foreign-key "workout_log_exercise_instances" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "workout_log_exercise_instances" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
...
func (wlq *WorkoutLogQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(workoutlog.Table, workoutlog.Columns, sqlgraph.NewFieldSpec(workoutlog.FieldID, field.TypeUUID))
	_spec.From = wlq.sql
